...
2. Check to see if the `javascript` variable includes the word `hard`
   ...
   - Console log the value of the `jsIsHard` variable to the console.
   - Then, console log the result of checking if `'hard'` is included in the javascript variable directly, without storing it in a variable first.
